  ...
  <div class="fade-in">
    ...
    <div class="container">
      <div class="search-container" style="text-align: center;">
        <input type="text" :value="searchTerm" placeholder="영화를 찾아보세요!" class="form-control search-input"
       @input="updateSearchTerm($event.target.value)" @keyup.enter="search"/>
    ...
    <h2 class="h2 text-center">G-Flex가 추천드리는 영화</h2>
    ...
    <div>
      <div class="center mt-5">
        <h3 v-if="exactMatches.length">검색 결과</h3>
        <div v-if="exactMatches.length" class="container-img">
      ...
      <div class="center">
        <h3 v-if="recommendedMovies.length">비슷한 작품</h3>
        <div v-if="recommendedMovies.length" class="container-img">
          <div
...
const updateSearchResults = async () => {
  if (searchTerm.value.trim() !== '') {
    try {
      ...
      console.error('Error occurred while updating search results:', error)
    }
  } else {
    // 검색어가 비어있는 경우 검색 결과를 초기화
    exactMatches.value = []
